...
local ui = UI.new("454 Private V2.3", 5013109572)
...
local theme = ui:addPage("Misc Beta", 5012544693)
local tab = ui:addPage("GunCheats", 5012544693)
local GunCheats = tab:addSection("Lag Switch"), false, function(toggle)

GunCheats:addToggle("Remove Camera Shake", false, function(toggle)
    esp.enemy = toggle 
end)

GunCheats:addToggle("No Sway", false, function()
	hook_return(TASK_ENUM.INIT_AIM_SWAY);
end)

GunCheats:addToggle("NoSpread", false, function()
...
GunCheats:addSlider("Reduce Recoil)", 0, 0, 100, functionfunction()
