...
local theme = ui:addPage("MiscBeta", 5012544693)
local tab = ui:addPage("GunCheats", 5012544693)

MiscBeta:addToggle("Remove Camera Shake", false, function(toggle)
    esp.enemy = toggle 
end)

MiscBeta:addToggle("No Sway", false, function()
	hook_return(TASK_ENUM.INIT_AIM_SWAY);
end)

MiscBeta:addToggle("NoSpread", false, function()
...
MiscBeta:addSlider("Reduce Recoil)", 0, 0, 100, functionfunction()
